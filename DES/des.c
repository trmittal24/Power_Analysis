...
if (key != NULL) {
   ...
   **************************************************************************/
   ...
   memcpy(temp, key, <img src="./images/smilies/icon_cool.gif" alt="8)" title="Cool">;
...
memcpy(temp, source, <img src="./images/smilies/icon_cool.gif" alt="8)" title="Cool">;
   ...
   **************************************************************************/
   ...
   for (j = 0; j < 8; j++) {
      ...
      ***********************************************************************/
      ...
      col = (bit_get(fblk, (j * 6)+1) * <img src="./images/smilies/icon_cool.gif" alt="8)" title="Cool"> + (bit_get(fblk, (j * 6)+2) * 4) +
